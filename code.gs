...
const PRODUCTS_DATA_RANGE = 'A4:E'; // Includes Category
...
/**
 * Fetches product data from the spreadsheet, including category from column E.
 */
function getProducts() {
  try {
    ...
    // Ensure range includes potential empty category cells
    const range = sheet.getRange('A4:E' + lastRow);
